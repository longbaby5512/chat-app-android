#ifndef CHAT_APP_HASH_H
#define CHAT_APP_HASH_H
...
private:
    ...
    static uint32_t majority(uint32_t, uint32_t, uint32_t);

    static uint32_t sig0(uint32_t);

    static uint32_t sig1(uint32_t);
